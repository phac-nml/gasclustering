...
- Added `--gm_batch_size` parameter which adjusts the number of records to process at a time for `gas mcluster`. See [PR #37](https://github.com/phac-nml/gasclustering/pull/37).
