...
- Set nextflow version 25.10.4 to replace 'latest-everything' to confirm compatibility with next IRIDA-Next nextflow version in `.github/workflows` for nf-test. [PR #76](https://github.com/phac-nml/gasclustering/pull/76)
...
- Version of `profile_dists` to `1.0.10`. [PR #67](https://github.com/phac-nml/gasclustering/pull/67)
...
- Upgraded ArborView to [v.0.1.2](https://github.com/phac-nml/ArborView/releases/tag/v0.1.2). Update `assets/AborView.html` in pipeline with [html/table.html](https://github.com/phac-nml/ArborView/blob/v0.1.2/html/table.html). [PR #57](https://github.com/phac-nml/gasclustering/pull/57)
...
- Update `ArborView` to `v.0.1.1`. [PR #55](https://github.com/phac-nml/gasclustering/pull/55)
